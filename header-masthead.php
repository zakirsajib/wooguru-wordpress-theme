...
<body <?php body_class('fade-in')?>>
        <div class="regular-masthead bg-blue-dark">
        ...
        <div class="row">
            <div class="small-12 column">
                <h1 class="text-center push-40">WooGuru Affiliate program</h1>
                <h2 class="h1 text-center subheader">Earn up to $39/mo per user</h2></div>
        </div>
    </div>
